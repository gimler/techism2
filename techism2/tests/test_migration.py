...
class MigrationTest(unittest.TestCase):
    ...
    def test_parse_event_osm(self):
        ...
        self.assertEquals(event['description'], u"Regelmäßiges Treffen für interessierte OpenStreetMap-Nutzer.")
    ...
    def test_parse_event_da(self):
        ...
        self.assertEquals(event['description'].rfind(u"Sehtest"), 952)
    ...
    def test_parse_event_mongo(self):
        ...
        #self.assertEquals(event['description'], u'')
        self.assertEquals(event['description'].find(u"Es gibt ja nicht nur"), 0)
        self.assertEquals(event['description'].rfind(u"Party am Abend"), 421)
